...
# Class 粒子系統與互動遊戲
![](https://hackmd.io/_uploads/H1wBL-AB2.gif)




```
let points =  [[1,3], [3, 4], [8, 5],[9,7],[9,15],[10,19],[11,12],[13,23],[15,24],[14,22],[13,19],[15,15], [16, 12], [17, 7],[18,5],[22,4],[25,3],[22,2],[17,1],[9,1],[3,2],[1,3]]
 var stroke_colors = "03045e-023e8a-0077b6-0096c7-00b4d8-48cae4-90e0ef-ade8f4-caf0f8".split("-").map(a=>"#"+a)
 var fill_colors = "d9ed92-b5e48c-99d98c-76c893-52b69a-34a0a4-168aad-1a759f-1e6091-184e77".split("-").map(a=>"#"+a)
...
class Bullet{
  constructor(args){
    ...
    this.color=args.color || "blue"//飛彈顏色
  }
  draw(){//劃出飛彈
    push()
      translate(this.p.x,this.p.y)
